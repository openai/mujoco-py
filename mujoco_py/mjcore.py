...
class MjModel(MjModelWrapper):
    ...
    def fullM(self):
        ...
        mjlib.mj_fullM(self.ptr, self.fullqM_tmp.astype(np.double).ctypes.data_as(POINTER(c_double)), self.data.qM.astype(np.double).ctypes.data_as(POINTER(c_double)))

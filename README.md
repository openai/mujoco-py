...
- Windows support is DEPRECATED and will be removed soon. One known good past
 version is [1.50.1.68](https://github.com/openai/mujoco-py/blob/9ea9bb000d6b8551b99f9aa440862e0c7f7b4191/README.md#requirements). For instructions on using this version with a Conda 
 environment, see [README.windows-conda.md](README.windows-conda.md)
